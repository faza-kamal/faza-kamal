# Hi there! 👋 I'm Muhammad Faza Kamal
...
Passionate developer who loves to code and explore new technologies!

## 💻 Tech Stack

```python
skills = {
    "languages": ["Python", "PHP", "SQL", "Ruby", "JavaScript", "CSS", "C++"],
    "currently_learning": "Always something new!",
    "interests": ["Web Development", "Backend", "Database Design"]
}
```
